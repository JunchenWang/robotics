...
dh_table = [alpha(6) + delta_alpha(6), a(6) + delta_a(6), d(1) + delta_d(1), theta(1) + delta_theta(1);
           alpha(1) + delta_alpha(1), a(1) + delta_a(1), d(2) + delta_d(2), theta(2) + delta_theta(2);
           alpha(2) + delta_alpha(2), a(2) + delta_a(2), d(3) + delta_d(3), theta(3) + delta_theta(3);
           alpha(3) + delta_alpha(3), a(3) + delta_a(3), d(4) + delta_d(4), theta(4) + delta_theta(4);
