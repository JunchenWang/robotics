...
% opt = optimset(opt, 'Display',  'iter', 'Algorithm', 'levenberg-marquardt','Jacobian', 'on', 'TolFun', 1e-12, 'TolX', 1e-12, 'DerivativeCheck', 'off');
% [x2,err,RESIDUAL,EXITFLAG,OUTPUT] = lsqnonlin(f, x0, [], [], opt);
